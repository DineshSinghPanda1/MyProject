    ...
    <v-tabs centered>
      ...
      <v-tab-item>
        ...
        <v-alert outlined color="purple">
          <v-layout>
            <v-flex cols="12" class="ma-2" v-for="card in cards" :key="card.id">
              <v-card raised shaped>
                <div id="avatar" class="text-center ma-5">
...
export default Vue.extend({
  ...
  data: () => ({
    ...
    item: 1,
    items: [
      { title: "Pooja", data: "Subject:", value: "English" },
      { title: "Pooja", data: "Duration:", value: "10:00-11:00" },
      { title: "Pooja", data: "Period:", value: "1" }
    ],
    cards: [
      {
        name: "Pooja kapri"
